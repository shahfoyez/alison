...
<!-- <div class="product-custom-fields">
    ...
    <label for="field4" hidden></label>Address</label>
    <input type="text" name="custom_input_4" id="field4" value="" hidden />
        ...
        <div class="product-custom-fields">
            <div class="product-custom-fields">
                <label for="field1">Course Name </label>
                <input type="text" name="custom_input_1" id="field1" value=""   />
                <label for="field2">User</label>
                <input type="text" name="custom_input_2" id="field2" value=""   />
                <label for="field3">Email</label>
                <input type="text" name="custom_input_3" id="field3" value=""   />
