        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="tab_default_1">
                ...
                <div class="ar-banner-cmn">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/dashboard-top-right-img.svg"
                        class="imgclass" alt="">
                </div>


                <!-- container for tawsif er code -->

                <div class="container" id="for-you-container">
                    <div class="for-you-steps-container">
                        <h4 class="steps-count">Steps 1 of 5</h4>
                    ...
                    <form action="" id="for-you-form">
                        ...
                        <div class="form-tab" id="main-goals">
                            ...
                            <div id="main-goals-inputs">
                                <input type="radio" name="main-goal" value="up-skill" id="up-skill">
                                <label for="up-skill" class="input-label">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/questionnaire-page-1-img-1.svg"
                                        class="" alt="">
                                    <p>I want to upskill</p>

                                </label>
                                <input type="radio" name="main-goal" value="change-career-filed"
                                    id="change-career-filed">
                                <label for="change-career-filed" class="input-label">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/questionnaire-page-1-img-2.svg"
                                        class="" alt="">
                                    <p>I want to change my career field</p>
                                </label>
                                <input type="radio" name="main-goal" value="hobbies-interest" id="hobbies-interest">
                                <label for="hobbies-interest" class="input-label">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/questionnaire-page-1-img-3.svg"
                                        class="" alt="">
                            ...
                            <div id="courses-category-select">
                                ...
                                <?php
                                    ...
                                    foreach ($categories as $category) {
                                        ...
                                        array_push($cat_array, $subcategories)
                                    ...
                                    ?>
                                <input type="checkbox" name="course-cat" value=<?php echo $cat_id; ?>
                                    id=<?php echo $cat_id; ?>>
                        ...
                        <div class="form-tab" id="courses-sub-categories">
                            ...
                            <div id="courses-sub-category-container"></div>
                        ...
                        <div class="form-tab" id="career-categories">
                            ...
                            <div id="courses-category-container"></div>
                            <button id="questionnaire-nav-next-three" class="questionnaire-nav-button" disabled>Next:
                ...
                <div class="container">
                    <div class="tab-content">
                                        ...
                                        <div class="ar-crs-prgrs">
                                            ...
                                            <div class="ar-crs-cntnt">
                                                ...
                                                <div class="ar-crs-p1h1">
                                                    ...
                                                    <div class="ar-crsr-mre">
                                                        <a href="#open-modal" class="crs-lng">Other Courses In Progress
                                                            <img
                                                                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/expand_icon.svg"></a>
                                                        <a href="#open-modal" class="crs-srt"
                                                            style="display:none;">Other's <img
                                                                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/expand_icon.svg"></a>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="open-modal" class="modal-window">
                                                    <div>
                                                        <a href="#" title="Close" class="modal-close"><img
                                                                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/close.svg"
                                                                alt="close"></a>
                                                    ...
                                                    <div class="d-flex-simi">
                                                        ...
                                                        <div class="ar-crs-dt">
                                                            ...
                                                            <a href="<?php the_permalink(); ?>"
                                                                class="ar-more-link">More Information <i
                                        ...
                                        <div class="sec4">
                                            ...
                                            <div class="box1">
                                                ...
                                                <div class="Statistics">
                                                    ...
                                                    <div class="sttc-2nd">
                                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/statistics_empty.svg"
                                                            class="sttcimg">
                                            ...
                                            <div class="box2">
                                                ...
                                                <div class="modtop">
                                                    <div class="medels">
                                                        ...
                                                        <div class="medsm">
                                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/medals-gold.svg"
                                                                class="sec4p2-img">
                                                            <div class="med2tt">
                                                        ...
                                                        <div class="medsm">
                                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/medals-silver.svg"
                                                                class="sec4p2-img">
                                                            <div class="med2tt">
                                                                <h4 class="modtnme">Gold</h4>
                                                                <h5 class="modtsub">Learn 3 days in a week to earn Gold
                                                        ...
                                                        <div class="medsm">
                                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/medals-bronze.svg"
                                                                class="sec4p2-img">
                                                            <div class="med2tt">
                                                                <h4 class="modtnme">Gold</h4>
                                                                <h5 class="modtsub">Learn 3 days in a week to earn Gold
                                                ...
                                                <div class="modbottom">
                                                    ...
                                                    <div class="medels2">
                                                        ...
                                                        <div class="medsm3">
                                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/medals-bronze-mini.svg"
                                                                class="miniimg">
                                                        </div>
                            ...
                            <div class="cards">
                                ...
                                <div class="card-item">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <img class="card-img"
                                            src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/resume-builder-illustration.svg"
                                            alt="" />
                                ...
                                <div class="card-item">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="uncardh">
                                            <img
                                                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/top-careers.svg">
                                        ...
                                        <p class="card-text-n">Preferred by 80% employers, take our Workplace
                        ...
                        <div class="tab-pane fade" id="tab3default">
                            ...
                            <h2 class="tab1h2" id="tab3default">Attend Skillwise’s Free Webinar on the Affiliate
                                Programme</h2>
                            ...
                            <div class="carditemlast">
                                <div class="cardbodylast">
                                    ...
                                    <div class="middleheader">
                                        ...
                                        <div class="onem">
                                            <div class="iclast3"><img
                                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/calendar.svg">
                                            </div>
                                    ...
                                    <div class="prflpost">
                                        ...
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/0fZUSA3dMREmeGJLhVQS1648478387.png"
                                            class="ppostimg">
            ...
            <div class="tab-pane" id="tab_default_7">
                ...
                <div class="container">
                    ...
                    <form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>"
                        ...
                        <label
                            for="pwd"><?php _e('Current Password <span>(required to update email or change current password)</span>', 'vibe'); ?></label>
                        <input type="password" name="pwd" id="pwd" size="16" value="" class="settings-input small" />
                        &nbsp;<a href="<?php echo wp_lostpassword_url(); ?>"
                            title="<?php _e('Password Lost and Found', 'vibe'); ?>"><?php _e('Lost your password?', 'vibe'); ?></a>

                        <?php endif; ?>

                        <label for="email"><?php _e('Account Email', 'vibe'); ?></label>
                        <input type="text" name="email" id="email" value="<?php echo bp_get_displayed_user_email(); ?>"
                            class="settings-input" />

                        <label
                            for="pass1"><?php _e('Change Password <span>(leave blank for no change)</span>', 'vibe'); ?></label>
                        <input type="password" name="pass1" id="pass1" size="16" value=""
                            class="settings-input small" /> &nbsp;<?php _e('New Password', 'vibe'); ?><br />
                        <input type="password" name="pass2" id="pass2" size="16" value=""
                            class="settings-input small" /> &nbsp;<?php _e('Repeat New Password', 'vibe'); ?>

                        <?php do_action('bp_core_general_settings_before_submit'); ?>

                        <div class="submit">
                            <input type="submit" name="submit" value="<?php _e('Save Changes', 'vibe'); ?>" id="submit"
                                class="auto" />
                        </div>
