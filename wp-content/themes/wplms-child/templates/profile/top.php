...
?>
<?php
    // check if user already submitted the form and get course suggestion
    $dataSubmitted = $for_you_obj->getUserSubmit($userId);
    if($dataSubmitted != null){
        $userRecommendedCourse = $for_you_obj->userRecommendedCourse($dataSubmitted[0]);
    }
            ...
            <div class="tab-content">
                <div class="tab-pane" id="tab_default_1">
                    ...
                    elseif(isset($dataSubmitted) && $dataSubmitted != null){
                        ...
                        <div class="container">
                        <?php
                        if($userRecommendedCourse != null){
                             foreach($userRecommendedCourse as $course){
                    ...
                    <script>
                        ...
                        stepCountSpan.innerText = stepCountSpan;
                    ...
                    <div class="container">
                        ...
                        <form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form" id="settings-form">
                            ...
                            <?php if (!is_super_admin()) : ?>
                                ...
                                &nbsp;<a href="<?php echo wp_lostpassword_url(); ?>" title="<?php _e('Password Lost and Found', 'vibe'); ?>"><?php _e('Lost your password?', 'vibe'); ?></a>
